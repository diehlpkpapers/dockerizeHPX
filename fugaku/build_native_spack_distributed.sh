...
spack -v  install --fresh -j 4 octotiger@master +kokkos +kokkos_hpx_kernels hydro_host_tasks=8 multipole_host_tasks=16 simd_extension=SVE simd_library=STD build_type=Release %gcc@12.2.0 ^/3wsaqfenmhn43st73fb2ffv5hqstdcqb ^hpx@master malloc=jemalloc networking=mpi +generic_coroutines  ^bzip2@1.0.6 ^git@2.39.1 ^cppuddle +allocator_counters ^silo~mpi ^ninja@1.11.1%gcc@12.2.0
